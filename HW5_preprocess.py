...
if __name__ == "__main__":
    x_train = get_all_reviews("/projects/training/bayw/NLP/aclImdb/train/")
    x_test = get_all_reviews("/projects/training/bayw/NLP/aclImdb/test/", load_train_data=False)

    preprocess_glove_features("/projects/training/bayw/NLP/glove.840B.300d.txt", x_train, x_test)
